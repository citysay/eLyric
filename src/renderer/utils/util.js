...
export function createWebAPIRequest(host, path, method, data, cookie, callback, errorcallback) {
  let music_req = ''
...
export function createRequest(path, method, data, callback, errorcallback) {
